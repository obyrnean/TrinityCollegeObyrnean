# Microprocessors with C and Assembly (Raspberry Pi Pico)
...
## Key Concepts
- Microprocessor architecture (ARM Cortex-M0+)
- Instruction set and register-level programming
- Writing and integrating **ARMv6-M Assembly** with C
- Bitwise operations and memory-mapped I/O
- Button debouncing and edge detection
- Delay loops and hardware timers
- Stack, subroutines, and calling conventions
- Hardware implementation and real-time testing
- Debugging with GPIO output and serial messages
