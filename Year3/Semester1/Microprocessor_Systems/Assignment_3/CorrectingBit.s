@ Begin by expanding the 8-bit value to 12-bits, inserting zeros in the positions for the four check bits (bit 0, bit 1, bit 3 and bit 7).
...
@ We now have a 12-bit value in R0 with empty (0) check bits in the correct positions
